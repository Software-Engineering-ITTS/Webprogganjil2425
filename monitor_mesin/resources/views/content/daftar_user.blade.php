    ...
    <div class="row">
        <div class="col-md-12 mb-10">
            <div class="relative flex items-center">
                <h1 class="font-medium text-lg text-gray-900 dark:text-white mb-4">Form Daftar User</h1>
        ...
        <tbody>
            @foreach ($user as $item)
                <tr>
                    ...
                    <td>{{ $item->email }}</td>
                    <td>{{ $item->role }}</td>
                    <td>{{ $item->last_login ? $item->last_login->format('Y-m-d H:i:s') : 'Never logged in' }}</td>
                    <td>
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-4 md:p-5 text-center">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are
                                                you
                                                sure you want to delete the user by name <span
                                                    class="font-medium">{{ $item->name }}</span>?</h3>
                                            <form method="POST" action="{{ route('daftar_user.destroy', $item->id) }}"
                                                class="inline-block">
                                                @csrf
                                                @method('DELETE')
