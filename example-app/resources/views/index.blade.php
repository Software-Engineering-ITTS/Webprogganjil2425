        ...
        <div class="col-md-8">
            ...
            <form id="mahasiswaForm" action="/index" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control" name="nim" id="nim" value="" required>
                    </div>
                </div>
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control" name="prodi" id="prodi" value="" required>
                    </div>
                </div>
                <div class="mb-3 row">
        ...
        <div class="col-md-4">
            ...
            <form id="fakultasForm" action="/fakultas" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="nama_fakultas" id="nama_fakultas" value=""
                            required>
                    </div>
                </div>
                <div class="mb-3 row">
            ...
            @foreach ($data as $item)
                <tr>
                    ...
                    <th><!-- Cek apakah gambar ada -->
                        @if ($item->image)
                            <!-- Menampilkan gambar -->
                            <img src="{{ asset('storage/' . $item->image) }}" alt="Gambar {{ $item->nama }}" width="50">
                        @else
                    ...
                    <td><a href="javascript:void(0)" class="edit-btn" data-id="{{ $item->id }}"
                            data-image="{{ $item->image }}" data-nim="{{ $item->nim }}" data-nama="{{ $item->nama }}"
                            data-prodi="{{ $item->prodi }}" data-id_fakultas="{{ $item->fakultas->id ?? '' }}"
