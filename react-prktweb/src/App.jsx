...
const WeddingRegistry = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-between h-screen bg-blue-50 px-6">
      {/* Text Content */}
      <div className="md:w-1/2 space-y-4 text-center md:text-left">
        <h1 className="text-3xl md:text-4xl font-bold text-gray-800">
          The Easiest Wedding Registry
        </h1>
        <p className="text-lg text-gray-600 leading-relaxed">
          All the gifts you could want, convenience for you and your guests,
          free wedding websites, and more.
        </p>
        <button className="bg-teal-500 text-white py-3 px-6 rounded-full shadow-lg hover:bg-teal-600 transition">
          Start Your Registry
        </button>
      </div>
