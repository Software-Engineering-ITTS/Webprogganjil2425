...
<body class="bg-gray-100 flex items-center justify-center min-h-screen bg-gradient-to-r from-blue-500 to-white h-64 w-full">
    <div class="bg-white shadow rounded-lg p-8 w-full max-w-sm">
        ...
        <form action="/login" method="POST">
            ...
            @endif
            <a class="text-blue-500 hover:underline" href="/register">Register</a>
