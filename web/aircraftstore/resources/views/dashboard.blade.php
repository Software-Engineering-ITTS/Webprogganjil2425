<x-app-layout>
    ...
    <div class="container mx-auto bg-gray-900 text-white p-9 rounded-xl">
        ...
        <ul class="list-decimal">
            ...
            <li>Expert and Experienced Team
            ...
            <li>Customization and Upgrade Services
            ...
            <li>Reputation and Trust <p> We are trusted by clients from various countries, including governments,
                    security agencies, and private
                    collectors. Our reputation is a testament to the quality of our services</p>
            </li>
            <li>Global Network <p> With a global network of partners, we have access to manufacturers, spare parts
