        ...
        <div class="flex">
            ...
            <main class="w-3/4 ml-4">
                <div class="bg-gray-400 p-4 rounded-lg shadow-md">
                    <h2 class="text-lg font-bold text-gray-700 mb-4">Update Data Aset Perusahaan</h2>

                    <form method="POST" action="/aset/{{ $data->id }}" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea
                                ...
                                rows="3"
                                required
                                class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">{{ $data->spesifikasi }}</textarea>
                        </div>
                        <div class="mb-4">
                        <img width="100" src="/img/{{ $data->gambar_aset }}">
                            <label for="gambar_aset" class="block text-sm font-medium text-white">Gambar Aset</label>
                            <input
                                type="file"
                                name="gambar_aset"
                                id="gambar_aset"
                                value="{{ $data->gambar_aset }}"
                                class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        <div class="mb-4">
