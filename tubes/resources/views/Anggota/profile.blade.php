    ...
    <form action="" class="flex flex-col w-2/5">
        <div class="space-y-3 grid grid-cols-2">
            ...
            <div>
                ...
                <input type="date" class="w-48 block p-2 mt-1 rounded-lg disabled:bg-gray-200 disabled:cursor-not-allowed"
                value="{{$users->tanggal_lahir}}" disabled>
            </div>
            <div>
                <label for="" class="font-semibold">Gender</label>
                <div class="p-4">
                    <input type="radio" name="gender" id="gender" value="Laki - Laki" class="p-2 disabled:cursor-not-allowed" disabled {{$users->gender ==  'Laki - Laki' ? 'checked' : ''}}>
                    <label for="" class="me-3">Laki - Laki</label>
                    <input type="radio" name="gender" id="gender" value="Perempuan" class="p-2 disabled:cursor-not-allowed" disabled {{$users->gender ==  'Perempuan' ? 'checked' : ''}}>
