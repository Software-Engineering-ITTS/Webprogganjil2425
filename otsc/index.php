    ...
    <div class="container-fluid p-5">
        ...
        <form action="" method="post">
            <div class="form-group my-4 px-5">
                ...
                <input type="text" id="txtKodeBarang" class="form-control" name="kodeBarang"
                    placeholder="masukkan kode barang">
            </div>

            <div class="form-group my-4 px-5">
                <label for="txtNamaBarang">Nama Barang</label>
                <input type="text" name="namaBarang" id="txtNamaBarang" class="form-control"
            ...
            <div class="d-flex gap-3 justify-content-end mx-5">
                ...
                <input id="btnSubmit" class="btn btn-primary my-4 px-5" type="button" value="submit">
            </div>
