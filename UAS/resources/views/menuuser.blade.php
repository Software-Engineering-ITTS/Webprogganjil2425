                ...
                <table class="min-w-full table-auto border-collapse">
                    <thead class="bg-gray-800 text-white">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left">Join</th>
                        </tr>
                    </thead>
                    ...
                    <tr class="border-t hover:bg-gray-50">
                        ...
                        <td class="px-6 py-3">
                            <a href="/event/{{ $items->id }}/edit">
                                <button type="button" class="px-4 py-2 bg-blue-500 text-white font-semibold rounded-md hover:bg-blue-600 transition duration-200">
                                    JOIN
                                </button>
                            </a>
                        </td>
